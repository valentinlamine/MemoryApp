...
import { Edit, Plus, Trash, AlertTriangle, Info } from "lucide-react"
...
export default function ThemesPage() {
  ...
  const handleAddCategory = async () => {
    try {
      ...
      toast({
        title: "Theme added",
        description: "Your new theme has been created.",
      })
    } catch (error) {
  ...
  const handleDeleteCategory = async () => {
    try {
      ...
      toast({
        title: "Theme deleted",
        description: "Your theme has been deleted.",
      })
    } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Create a new theme to organize your flashcards.</DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              <Alert className="mb-4">
                <Info className="h-4 w-4" />
                <AlertTitle>Simplified Schema</AlertTitle>
                <AlertDescription>In this simplified version, themes are implemented as categories.</AlertDescription>
              </Alert>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., Algebra, Spanish Verbs, Biology Terms"
                />
              </div>
              <div className="space-y-2">
            ...
            <DialogFooter>
              ...
              <Button onClick={handleAddCategory}>Add Theme</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
      ...
      <Alert className="mb-6">
        ...
        <AlertTitle>Simplified Schema</AlertTitle>
        <AlertDescription>
          In this simplified version, themes are implemented as categories. You can create and manage themes here.
        </AlertDescription>
      </Alert>
      ...
      {categories.length === 0 ? (
        <Card className="text-center p-8">
          <CardHeader>
            ...
            <CardDescription>Create your first theme to start organizing your flashcards.</CardDescription>
          </CardHeader>
          <CardFooter className="justify-center">
